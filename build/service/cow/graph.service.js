...
var graph_1 = require("../../entity/cow/report/graph");
var report_1 = require("../../entity/cow/report/report");
var GraphProvider = /** @class */ (function () {
    function GraphProvider() {
        this.reportRepository = data_source_1.AppDataSource.getRepository(graph_1.GraphState);
    }
    GraphProvider.prototype.getAllGraph = function () {
    ...
    GraphProvider.prototype.addedNewStateOfGraph = function (req, response) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var newState;
